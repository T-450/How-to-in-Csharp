...
internal class Program
{
    ...
    public async void ProcessText()
    {
        ...
        Console.WriteLine("Reading a file with stream...");
        var result = await fileProcessor.ReadAsync().ConfigureAwait(false);
        Console.WriteLine("Writing to a file with stream...");
    ...
    public void ProcessBinary()
    {
        ...
        Console.WriteLine("Reading a binary file with stream...");
        var result = fileProcessor.Read();
        Console.WriteLine("Writing to a binary file with stream...");
