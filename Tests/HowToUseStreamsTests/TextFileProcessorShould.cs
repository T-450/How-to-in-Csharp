...
public class TextFileProcessorShould
{
    ...
    private static readonly string filePath =
        Path.Combine(currentDir, "Resources", "Far_Over_the_Misty_Mountains_Cold.txt");

    private static readonly string outputPath = Path.Combine(currentDir, "Resources", "output.txt");
